...
*/
public class AutenticadorBiometrico extends validarAcesso {
        private boolean Confimador;

    public AutenticadorBiometrico(boolean Confimador) {
    ...
    public void validarAcesso(String credencial) {
        if (Confimador == true) {
            System.out.println("Biometria Valida");
            System.out.println("Acesso Permitido para " +credencial);
        }
        else {
            System.out.println("Biometria Invalida");
            System.out.println(credencial+ " Foi Bloqueada");
        }
    }
}